...
import { Item, spawnConfusionScroll, spawnFireballScroll, spawnLightningScroll, spawnHealthPotion, spawnOrc, spawnTroll } from '../entity';
...
export class GameScreen extends BaseScreen {
  ...
  constructor(display: Display, player: Actor, serializedGameMap: string | null = null, public currentFloor: number = 0) {
